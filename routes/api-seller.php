...
use App\Http\Controllers\stores\StoreBuyerController;
use App\Http\Controllers\stores\StoreController;
use App\Http\Controllers\Collection\CollectionController;
use App\Http\Controllers\Products\ProductController;

Route::group(['prefix' => 'seller', 'middleware' => 'jwt.auth','role:3', 'namespace' => 'seller'], function () {
  Route::post('addcollection', [CollectionController::class, 'addcollection']);
  Route::get('getmyproductsc', [CollectionController::class, 'getmyproducts']);
  Route::get('showcollections/{sellerid}', [CollectionController::class, 'getCollectionProduct']);
  Route::get('deletecollection/{collectionid}', [CollectionController::class, 'destroy']);
  Route::get('editcollection/{collectionid}', [CollectionController::class, 'edit']);
  Route::get('editcollectionproduct/{collectionid}', [CollectionController::class, 'editCollectionProduct']);
  Route::post('updatecollection/{collectionid}', [CollectionController::class, 'update']);
});


Route::group(['prefix' => 'stores', 'middleware' => 'jwt.auth','role:3', 'namespace' => 'stores'], function () {
  Route::get('/{slug}', [StoreBuyerController::class, 'show']);
  // Route::get('/rss', [StoreBuyerController::class, 'getmystores']); //added
  Route::post('addstores', [StoreController::class, 'store']);
  Route::get('editstores/{storeid}', [StoreController::class, 'edit']);
  Route::post('editstores/{storeid}', [StoreController::class, 'update']);
  Route::get('deletestores/{storeid}', [StoreController::class, 'destroy']);
  Route::get('show/mystores', [StoreController::class, 'mystores']); //seller
  Route::get('searchstores', [StoreController::class, 'searchstores']);
  Route::post('searchstores', [StoreController::class, 'searchstores']);
});
...
Route::get('getcategorybrands/{slug}', 'Categories\BrandController@getCategoryBrands');
...
Route::group([
  ...
  Route::post('attributeproductstore', 'AttributesetController@store'); //seller
