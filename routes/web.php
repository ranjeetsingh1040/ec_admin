...
Route::group([
  ...
  'prefix' => 'admin',
  'namespace' => 'Admin\ShippingMethod'
], function () {
...
Route::group(['middleware' => ['auth', 'admin1'], 'prefix' => 'admin', 'namespace' => 'Admin\Review'], function () {
  ...
  Route::get('/banner/add', [BannerController::class, 'show']);
  Route::post('/banner/add', [BannerController::class, 'store']);
  Route::get('/banner', [BannerController::class, 'index']);
  Route::post('/banner/change/{id}', [BannerController::class, 'change']);
