...
class CategoryController extends Controller
{
    ...
    {
        $CategoryProduct = CategoryProduct::groupBy('category_id')->get(['category_id'])->toArray();
        $subcategory = Category::whereNotNull('parent_id')->whereIn('id', $CategoryProduct)->get();
        $subcategory = $subcategory->take(50)->toArray();
        return [
