  ...
  public function verify($token)
  {
    ...
    if (isset($user)) {
      ...
      if ($mailtemplate->status == 'active') {
        ...
        //  return  redirect()->back()->with('success','Password send successfully.Please check your email.');
        return redirect('/')->with('success', 'Password send successfully.Please check your email.');
      } else {
        return redirect('/')->with('error', 'Password does not send.');
        // return  redirect()->back()->with('error','Password does not send.');
      }
    }
  }
}
