...
class ProductIndexResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'user' => $this->users->id,
            'sellerbusinessname' => $this->users->sellerprofies[0]->business_name,
            // 'user' => UserResource::collection($this->users),
            // 'user' => $this->users->name,
            // 'user' => $this->users,  //remove by me
            'name' => $this->name,
            'brand' => $this->brand,
            'slug' => $this->slug,
            ...
            'categorychild' => $this->categories[0]->name,
            ...
            'slicename' => Str::limit($this->name, 80, ' ...'),
        ];
    }
}
