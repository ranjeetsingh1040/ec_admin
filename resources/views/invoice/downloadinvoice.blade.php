  ...
  <table width="100%" style="border:1px solid #e4e4e4">
    <tr>
      <th style="text-align: left;">
        {{-- <img src="{{ asset('/images/logo.png') }}" class="h-16" alt="invoice" style="max-width:400px;height:50px"> --}}
        <img src="/images/logo.png" class="h-16" alt="invoice" style="max-width:400px;height:50px">
      </th>
    ...
    <tr>
      <td style="text-align: left;">
        <p style="font-size:10px;">Sold By:{{$sellername}}<br></p>
        {{-- <p style="font-size:10px;">{{$sellerstoreadd}}</p> --}}
      </td>
      <td style="text-align:right;">
          ...
          <span style="font-size:10px;">{{$billaddress}}<br></span>
   ...
   <tr>
    <td></td>
      <td style="text-align:right;">
          ...
          <span style="font-size:10px;">{{$shippingaddress}}<br></span>
  ...
  <table border width="100%" style="border:1px solid #e4e4e4">
   ...
   <tr>
    ...
    <td style="text-align:right"><span style="font-size:10px;text-align: right;">
      <small>{{$orderitems[0]->currency->currency()}}</small>  {{$overalltotal}}</span></td>
   </tr>
 </table><br>
 <table border width="100%" style="border:1px solid #e4e4e4">
   <thead>
    <tr style="background-color:#e4e4e4">
    <th style="text-align:left"><span style="font-size:8px;font-weight:700;">Description</span></th>
   ...
   <tr>
    <td style="text-align:left"><span style="font-size:8px;">{{$orderitems[$i]->productdetail['product']['name']}}</span></td>
