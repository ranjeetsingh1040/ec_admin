...
<div class="w-32 menu-open hidden lg:block absolute lg:relative">
        ...
        <ul class="list-reset text-xs leading-loose  py-2 custom_shadow h-full">
            ...
            <li class="px-3 py-2 {{ $class }}">
                ...
                <ul class="list-reset sidebar_submenu py-2 rounded-r">
                    <li class="px-3 py-1"><a href="{{ url('/admin/giftorder') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/approve.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.giftorder') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/completed') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/approve.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.completed') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/pending') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/pending.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.pending') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/processing') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/process.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.processing') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/paymentfailed') }}"
                            class="flex items-center"><img src="{{ url('images/icons_1/payment.svg') }}"
                                class="w-4 h-4"><span class="mx-2">{{ trans('sidebar.payment') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/shipped') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/truck.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.shipped') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/hold') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/truck.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.hold') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/refunded') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/refund.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.refunded') }}</span></a></li>
                    <li class="px-3 py-1"><a href="{{ url('/admin/order/cancel') }}" class="flex items-center"><img
                                src="{{ url('images/icons_1/refund.svg') }}" class="w-4 h-4"><span
                                class="mx-2">{{ trans('sidebar.cancel') }}</span></a></li>
                </ul>
            ...
            <li class=" py-2 {{ $class }}">
                <a href="{{ url('/admin/mailtemplates') }}"
                    class="flex flex-col items-center px-2 py-2 rounded active_link">
    ...
    <span class="mt-1">{{ trans('sidebar.settings') }}</span></a>
            ...
            <li class="px-3 py-2  {{ $class }}">
                <a href="{{ url('/admin/shippingmethod') }}"
                    ...
                    <span class="mt-1 whitespace-nowrap"
                        style="width: max-content">{{ trans('sidebar.shippingmethod') }}</span></a>
            ...
            @endphp
            <li class="px-3 py-2  {{ $class }}">
                <a href="{{ url('/admin/paymentmethod') }}"
                    class="flex flex-col items-center px-2 py-2 rounded active_link">
                    @include('admin.sidebar.shipping_method')
                    <span class="mt-1 whitespace-nowrap"
                        style="width: max-content">{{ trans('sidebar.paymentmethod') }}</span></a>
            ...
            <li class="px-3 py-2  {{ $class }}">
                <a href="{{ url('/admin/reviews') }}"
                    class="flex flex-col items-center px-2 py-2 rounded active_link">
                    @include('admin.sidebar.shipping_method')
                    <span class="mt-1 whitespace-nowrap">{{ trans('details.reviews') }}</span></a>
            ...
            <li class="px-3 py-2  {{ $class }}">
                <a href="{{ url('/admin/banner') }}"
                    class="flex flex-col items-center px-2 py-2 rounded active_link">
                    @include('admin.sidebar.shipping_method')
                    <span class="mt-1 whitespace-nowrap">{{ trans('Banner') }}</span></a>
